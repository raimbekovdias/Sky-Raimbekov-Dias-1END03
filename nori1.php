		...
		<div class="menu">
			...
			<div class="col-md-3" style="background-color:#FF4A75; min-height:200px;font-size:15px; width:439px">
				...
				<div style = " text-align: center; margin-left: 120px;">
					<a href="https://vk.com/dias10" target="_blank"><img src="vkicon1.png" width="40" ></a>
					<img src="instaicon.png"width="40" style ="margin-left: 20px;" >
					<img src="faceicon1.png"width="40" style ="margin-left: 20px;" >
				</div>
			</div>
		</div>
	</div>
		...
		<div class="mainmenu">
			<div class="menu1">
				<div class="row">
					<div class="col-md-3">
						<div class="kartinka">
							<img src="pizza.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
					<div class="col-md-3">
						<div class="kartinka">
							<img src="sushi.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
					<div class="col-md-3">
						<div class="kartinka">
							<img src="sandwich2.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
					<div class="col-md-3">
						<div class="kartinka">
							<img src="salat.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
				</div>
			</div>
			<div class="menu2">
				<div class="row">
					<div class="col-md-3">
						<div class="kartinka">
							<img src="desert.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
					<div class="col-md-3">
						<div class="kartinka">
							<img src="gor3.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
					<div class="col-md-3">
						<div class="kartinka">
							<img src="napitki.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
					<div class="col-md-3">
						<div class="kartinka">
							<img src="hookah3.jpg" class="pictureborder" style="width:310px; height:203px;">
						</div>
					</div>
				</div>
			</div>
